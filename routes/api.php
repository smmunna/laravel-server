...
// cors will added this way Route::group(['prefix' => '/v1', 'middleware' => 'custom_cors'],
Route::group(['prefix' => '/v1'], function () { // goto app/middleware/CustomeCors.php further customization
